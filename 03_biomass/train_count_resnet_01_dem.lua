...
local outModelFile = "model_count_01_dem";
...
local inSize, inDim, outSize = 192, 1, 192;
local batchSize = 32;
local numEpochs = 100;
----------------------------------------------------
...
-- specify log file
trainLogger = optim.Logger('./logs/train_count_resnet_01_dem_part1.log');
			...
			for fileId = batch_st, batch_ed, 1 do
				donkeys:addjob(
					function()
						...
						inputsCpu[placeId] = torch.load(paths.concat(pathTrainDem, tostring(fileList[fileId]) .. '.dat'));
