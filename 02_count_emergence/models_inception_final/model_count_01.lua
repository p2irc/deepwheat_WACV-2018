...
local function longInceptionBlock(numMapsIn, numMapsOut, numMapsLrn)
...
local features = nn.Sequential()
	...
	-- replacement of resBlock with basicBlock
	:add(basicBlock(sizeStart, sizeStart, 3, 1, 1, 5) ) -- 128 x 112 x 112
	:add(basicBlock(sizeStart, sizeStart, 3, 1, 1, 5) ) -- 128 x 112 x 112
	:add(basicBlock(sizeStart, sizeStart, 3, 1, 1, 5) ) -- 128 x 112 x 112
	:add(basicBlock(sizeStart, sizeStart, 3, 1, 1, 5) ) -- 128 x 112 x 112
	:add(basicBlock(sizeStart, sizeStart, 3, 1, 1, 5) ) -- 128 x 112 x 112
	...
	-- replacement of all resInceptionBlock with longInceptionBlock
	:add(longInceptionBlock(2*sizeStart, 2*sizeStart, 10)) -- 256 x 56 x 56
	:add(longInceptionBlock(2*sizeStart, 2*sizeStart, 10)) -- 256 x 56 x 56
	:add(longInceptionBlock(2*sizeStart, 2*sizeStart, 10)) -- 256 x 56 x 56
	...
	:add(longInceptionBlock(4*sizeStart, 4*sizeStart, 10) )  -- 512 x 28 x 28
	:add(longInceptionBlock(4*sizeStart, 4*sizeStart, 10) )  -- 512 x 28 x 28
	:add(longInceptionBlock(4*sizeStart, 4*sizeStart, 10) )  -- 512 x 28 x 28
